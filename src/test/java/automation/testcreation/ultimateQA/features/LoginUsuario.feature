Feature: Login Usuario
  ...
  Scenario: Registro nuevo usuario
    ...
    When el usuario ingresa los datos "Isaac", "Romero", "isaac16romero@gmail.com", "123456prueba"
  ...
  Scenario: Login exitoso
    ...
    When el usuario ingresa el "isaac16romero@gmail.com" y la "123456prueba" correspondiente
    ...
    Scenario: Login fallido
      ...
      When el usuario ingresa el "isaac16romero@gmail.com" y la "123456pruebaf"
  ...
  Scenario: Recuperacion credenciales
    ...
    When el usuario ingresa "isaac16romero@gmail.com" y presiona el boton Submit
